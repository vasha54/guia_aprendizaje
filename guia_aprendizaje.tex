...
\titleguide{Los caminos más largos de un árbol}%all_longest_paths_tree
...
\input{tex_files/introduccion_all_longest_paths_tree.tex}
\section{Conocimientos previos}
\input{tex_files/conocimientos_all_longest_paths_tree.tex}
\section{Desarrollo}
\input{tex_files/desarrollo_all_longest_paths_tree.tex}
\section{Implementación}
\input{tex_files/code_all_longest_paths_tree.tex}
\section{Aplicaciones}
\input{tex_files/aplicaciones_all_longest_paths_tree.tex}
\section{Complejidad}
\input{tex_files/complejidad_all_longest_paths_tree.tex}
\section{Ejercicios}
\input{tex_files/excercises_all_longest_paths_tree.tex}
