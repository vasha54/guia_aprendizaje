...
%\titleguide{Exponenciación binaria}%_pow_binary
%\titleguide{Algoritmo de la criba Eratóstenes}%sieve_eratosthenes
%\titleguide{Algoritmo de la criba linear}%_linear_sieve
%\titleguide{Pruebas de primalidad}%_primality_test
%\titleguide{Factorización de enteros}%_integer_factorization
%\titleguide{La función totiente de Euler ($\phi(n)$)}%_euler_totient_function
%\titleguide{Cantidad y suma de los divisores}%_numbers_and_sums_divisors
%\titleguide{Búsqueda binaria}%_busqueda_binaria
%\titleguide{Integración por la fórmula de Simpson}%_simpson_integration
%\titleguide{Aritmética Modular}%_arithmetic_modular
%\titleguide{Selección rápida \emph{QuickSelect}}%_k-th_order
...
%\titleguide{Ordenamiento por burbuja}%_burble_sort FALTA
%\titleguide{Ordenamiento por selección}%_selection_sort FALTA
%\titleguide{Ordenamiento por inserción}%_insertion_sort FALTA
%\titleguide{Ordenamiento por montículos}%_heap_sort FALTA
%\titleguide{Ordenamiento por mezcla}%_merge_sort FALTA
%\titleguide{Ordenamiento rápido}%_quick_sort FALTA
%\titleguide{Ordenamiento por conteo}%_counting_sort FALTA
%\titleguide{Ordenamiento Radix }%_radix_sort FALTA
%\titleguide{Ordenamiento Shell }%_shell_sort FALTA
%\titleguide{Métodos de ordenamientos en C++}%_function_sort_cpp FALTA
%\titleguide{Métodos de ordenamientos en Java}%_function_sort_java FALTA
%\titleguide{Ecuación de congruencia lineal}%_linear_congruence_equation FALTA
%\titleguide{Teorema del resto chino}%_chinese_remainder_theorem FALTA
%\titleguide{Algoritmo de Garner}%_garner_algorithm FALTA
%\titleguide{Factorial modulo p}%_factorial_modulo_p FALTA 
...
\input{tex_files/introduccion_factorial_modulo_p.tex}
\section{Conocimientos previos}
\input{tex_files/conocimientos_factorial_modulo_p.tex}
\section{Desarrollo}
\input{tex_files/desarrollo_factorial_modulo_p.tex}
\section{Implementación}
\input{tex_files/code_factorial_modulo_p.tex}
\section{Aplicaciones}
\input{tex_files/aplicaciones_factorial_modulo_p.tex}
\section{Complejidad}
\input{tex_files/complejidad_factorial_modulo_p.tex}
\section{Ejercicios}
\input{tex_files/excercises_factorial_modulo_p.tex}
%\section{Anexos}
